NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$rootscope $scope allowed angular api btn btn-default btn-group button caret checkbox class clicked close closed col-sm-10 col-sm-2 component control-label controller danger default delay directive disappear dropdown-menu-right element false form-control form-group form-horizontal function header html info ispersistent item js main manually menu menuitem message module ng-class ng-click ng-controller ng-model ng-repeat notification notificationdemoctrl notifications null patternfly pf-notification-header pf-notification-message pf-notification-persistent pf-notification-remove pf-notification-type pfnotificationheader pfnotificationmessage pfnotificationpersistent pfnotificationremove pfnotificationtype remove removenotification role script selected success tabindex text timeout type types uib-dropdown uib-dropdown-menu uib-dropdown-toggle updatetype visual warning won"
    },
    {
      "section": "api",
