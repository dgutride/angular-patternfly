NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "type": "directive",
      "moduleName": "patternfly.charts",
      "shortDescription": "Component for rendering a topology chart.  Individual nodes and relationships can be represented with this view.  CSS is especially important for rendering the noes and lines.  The example inline contains specific examples that can be used to change the icon size and the line type of the relationships.",
      "keywords": "$rootscope $scope addition angular api appropriate argument associated attribute availabilityzone behavior beneath boolean button change changes chart chartrendered charts checkbox circle class color component configuration container container-topology container10r235 container10r236 containergroup containergroup10r240 containergroup10r241 containergroupcontainerreplicator containergroupcontainerservice containermanager containermanager10r20 containernode containernode10r14 containerreplicator containerreplicator10r56 containerreplicator10r57 containerreplicatorcontainergroup containerroute containerservice containerservice10r61 containerservicecontainergroup containerservicecontainerroute controller controls correspond creating css d3 data datasets default delete determines differentiate directive dispatched display display_kind displayed docker-registry docker-registry-2 docker-registry-2-vrguw element elements enabled event example examples ff7f0e fill filtering font-family font-size fontawesome fontfamily force function getelementbyid glyph height highlights host html icon icons implementation individual inline input item item-selected items itemselected js key kind kinds kubernetes label labels lables layout lines list-style-type matching metadata miq_id module ng-click ng-controller ng-model node nodekinds nodes noes object ocp-master openshiftenterprise optional overwrite passed patternfly patternflyicons-webfont pf-topology-svg pod prevent preventdefault push radius ready registry relations relationships remove removekind rendering replicationcontroller replicationcontrollerpod replicator representations represented represents return round running script search search-text searching searchtext selected selection service set sets show-labels showlabels sink size source specific started status statuses stroke-dasharray stroke-linecap style supported target text textx texty title tooltip tooltip-function tooltipfunction topology topologyctrl true tweaks type types unknown updated usual valid values var view visibility vm watched width"
    },
    {
      "section": "api",
