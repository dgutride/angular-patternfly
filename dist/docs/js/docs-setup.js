NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$scope $stateprovider $states $urlrouterprovider absolutely active add addclass additional angular angular-ui-router api aria-expanded aria-haspopup aria-labelledby badge badgeclass badges bar brand brand-alt brandalt brandsrc btn btn-primary callback card-pf card-pf-accented card-pf-aggregate-status card-pf-aggregate-status-notifications card-pf-body caret change children class classes click component config container container-cards-pf container-fluid container-pf-nav-pf-vertical content contentcontainer controller count dashboard data-toggle default demo deps directive display displayed dolor dropdown dropdown-menu dropdown-toggle dropdownmenu1 dropdownmenu2 element example example-info-text example-page-container exit fa fa-dashboard fa-shield fa-space-shuttle false faux-layout filters flag function handlenavigateclickrouter height help hidden hiddenicons hide-vertical-nav hideverticalnav hideverticalnavwithrouter href html icon iconclass icons ignored ignoremobile image invoked ipsum item itemclickcallback items js layout-pf layout-pf-fixed level link list list-style-type marked menu menus method mobile mock module myapp nav nav-item-iconic navbar-iconic navbar-nav navbar-right navigate navigate-callback navigatecallback navigation navigationitems ng-click ng-controller patternfly persistent persistentsecondary pficon-help pficon-user pfverticalnavigation pinnable-menus primary product queryselector removeclass return router script secondary show-badges showbadges showdemocontroller showing showverticalnav showverticalnavwithrouter sort src structure style submenu submenus template text title tooltip top true ui uirouter uisref uisrefs update-active-items-on-click updateactiveitemsonclick url username utils vertical verticalnavwithrouterlayout vertnavwithroutercontroller views"
    },
    {
      "section": "api",
      ...
      "keywords": "$scope allowed angular api btn btn-default btn-group button caret checkbox class close closed col-sm-10 col-sm-2 control-label controller danger default delay directive disappear dropdown-menu-right element false form-control form-group form-horizontal function header html info ispersistent item js main manually menu menuitem message module ng-class ng-click ng-controller ng-model ng-repeat notification notificationdemoctrl notifications patternfly pf-notification-header pf-notification-message pf-notification-persistent pf-notification-type pfnotificationheader pfnotificationmessage pfnotificationpersistent pfnotificationtype role script selected success tabindex text timeout type types uib-dropdown uib-dropdown-menu uib-dropdown-toggle updatetype visual warning won"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "$scope angular api automatically btn btn-default btn-group button caret class click col-sm-10 col-sm-12 col-sm-2 control-label controller creates danger default directive dropdown-menu-right error form-control form-group form-horizontal function generated html info item js list menu menuitem message module ng-class ng-click ng-controller ng-model ng-repeat notification notificationdemoctrl notifications notify object patternfly role script selected service success tabindex text times type typemap types uib-dropdown uib-dropdown-menu uib-dropdown-toggle updatetype var warn warning"
    },
    {
      "section": "api",
      ...
      "keywords": "$scope $watch action action-callback action-title actioncallback actionfn actions actions-label actiontext actiontitle add allow allowed allows angular api block btn btn-default btn-group button callbacks capabilities caret checkbox class close close-callback closecallback col-md-12 col-sm-10 col-sm-2 col-sm-3 control-label controller currently danger data default directive disable disabled displayed dropdown-menu-right example-container false flag form-control form-group form-horizontal function grouped handleaction header html info invoke isdisabled isseparator item js kebab list list-style-type long main menu menu-actions menuaction menuactions menuitem message module needed ng-class ng-click ng-controller ng-model ng-repeat note notification notification-type notifications notificationtype notify occurence optional patternfly perform performaction pf-toast-notification pftoastnotification place placehodler primary primaryaction read role row rows screen script seconds selected separator set show-close showclose showmenu status stay style success supported system tabindex text title toast toastnotificationdemoctrl transient true type types uib-dropdown uib-dropdown-menu uib-dropdown-toggle unavailable undefined updatetype updateviewing user users var viewing warning"
    },
    {
      "section": "api",
      ...
      "keywords": "$rootscope $scope action actioncallback actionfn actions actions-label actiontext actiontitle allowed angular api btn btn-default btn-group button buttons caret checkbox class click close close-callback closecallback closed closes col-md-12 col-sm-1 col-sm-10 col-sm-12 col-sm-2 col-sm-3 control-label controller current danger data default directive disable disabled display displayed displayes dropdown-menu-right example-container false flag form-control form-group form-horizontal function grouped handleaction handleclose header html info invoke isdisabled ispersistent isseparator item js kebab list list-style-type main menu menuaction menuactions menuitem message module ng-class ng-click ng-controller ng-model ng-repeat notifcations notification notifications notify object optional patternfly perform performaction persistent pf-toast-notification-list pftoastnotification place placehodler primary primaryaction remove role row rows script selected separator set setviewing show-close showclose showmenu style success tabindex text times title toast toastnotificationlistdemoctrl true type typemap types uib-dropdown uib-dropdown-menu uib-dropdown-toggle unavailable undefined update-viewing updatetype updateviewing user var viewing warning"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "$parent $scope $templatecache access accessed action action-buttons actionbuttons actionfn actions ad add address adipisicing aliqua aliquip allow amet angular anim api applicable array aute based bedrock boston bourbon boxes brown btn-primary button buttoninclude buttons california call called center-label change changes chartid checkbox checkbox-inline checkdisabled checkdisableditem checked cillum city class click clicked clicking col-md-12 col-md-3 col-md-9 colorado commodo component config configuration consectetur consequat content controller cross culpa cupidatat current custom customscope data dblclick default denver deps deserunt determine determining dinosaur directive disable disabled disablerowexpansion display displayed div dl-horizontal dlbclick dolor dolore double dropdown dropdowns duis ea east edwards eiusmod element elit elm enable-button-for-item-fn enablebuttonforitemfn enabled enim error esse est eu event eventtext example-container example-list-view examplechartconfig examplelistview excepteur exercitation expandable expanding expansion fa fa-plus false field flintstone font-weight form form-group frank fred fugiat function gb getmenuclass grouped handle handlecheckboxchange handleclick handledblclick handleselect handleselectionchange hide hide-menu-for-item-fn hidemenuactions hidemenuforitemfn hmtl holly hollywood html incididunt include includeclass inside invoke ipsum irure isdisabled isseparator isvisible item items jim john js jump kebab labore laboris laborum layouts length linda list list-expanded-content list-group-item-heading list-group-item-text list-style-type list-view-container list-view-pf-additional-info list-view-pf-additional-info-item list-view-pf-description livingston lorem magna main marie massachusetts matching mcgovern menu menu-actions menu-class-for-item-fn menuactions menuclass menuclassforitemfn minim module mollit multiple multiselect my-button-template nashville ng-change ng-controller ng-disabled ng-model nichols nisi norfolk nostrud notify nulla oak object occaecat officia oncheckboxchange onclick ondblclick onselect onselectionchange optional pariatur pass pat patternfly pctchart pennsylvania percent perform performaction pf-donut-pct-chart pittsburgh placeholder proident property qui quis radio radio-inline red relevant remains rendering reprehenderit return role row rowclass rows scope script second sed select selected selecteditems selection selectionmatchprop selections selectitems selecttype separator server set setting settings showdisabled showselectbox sint sit smith source special src start start-button-template startbuttoninclude started starting startserver street style sunt tempor tennessee thomas thresholds title tooltip total transcluded true type ullamco unavailable units update update-menu-action-for-item-fn updatemenuactionforitemfn updateselectiontype useexpandingrows ut utils uuid var variables velit veniam view viewctrl views virginia voluptate warning washingstone york"
    },
    {
      "section": "api",
